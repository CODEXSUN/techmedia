...
const treeData = [
  ...
  },
  {
    label: "Business Apps",
    value: "business-apps",
    children: [{ label: "Application", value: "application" }]
  }
];
...
export const catalogItems: CatalogItem[] = [
  ...
  item("card", "Card", "Layout", "Framed content surface for repeated items and focused panels.", [
    variant(
      "default",
      "Default",
      <Card title="Application Engine" description="Modules, workflows, access, and compliance.">
        <StatusRow />
      </Card>
    ),
    variant(
  ...
  item(
    ...
    "Global Loader",
    "Feedback",
    "TECHMEDIA loading indicator for full page or inline loading.",
    [
      variant(
        "inline",
        "Inline",
