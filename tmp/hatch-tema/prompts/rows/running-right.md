Create one horizontal animation strip for Codex pet `tema`, state `running-right`.
...
Identity: same pet in every frame: Compact friendly purple 3D toy robot, glossy black screen face with cyan pixel eyes and smile, single antenna, cyan chest power light, purple vest, sturdy sneakers, approachable business helper. Preserve identity but omit readable words and tiny logos at sprite size.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: Polished stylized 3D mascot, clean readable silhouette, purple and cyan palette, no text, no floor shadow..
