...
This note is the working source of truth for TECHMEDIA tenancy. It tells humans and AI assistants what is already implemented, what must remain true, and what is still required before the product can be treated as production-complete for multi-tenant, multi-database, multi-industry, multi-company operation.

## Target Architecture

TECHMEDIA is intended to be:
