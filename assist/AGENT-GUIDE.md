...
This is the authoritative working note for every human or AI agent changing TECHMEDIA. Read this file first. Open a specialized Assist document only when the task touches that area.
...
- TECHMEDIA is a modular monolith with explicit application and leaf-module ownership.
