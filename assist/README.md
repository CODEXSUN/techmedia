# TECHMEDIA Assist Pack

## Purpose

TECHMEDIA is a SaaS business application platform for multi-tenant, multi-industry, multi-app, multi-port, and
...
TECHMEDIA. It contains product scope, architecture principles, module boundaries, agent behavior rules, versioning notes,
and change history.
...
rhythm into TECHMEDIA through `@codexsun/ui`; do not paste unrelated business logic or old module boundaries blindly.

## Current TechMedia Baseline

TechMedia is an independent application composition derived from the platform foundation. Its current and complete
...
TECHMEDIA should become a business operating platform where each customer receives an isolated, customizable system that
...
TECHMEDIA follows a scalable modular monolith architecture with Domain-Driven Design, event-driven workflows, queue
...
TECHMEDIA must support multiple industries through industry packs. Initial examples include:
...
TECHMEDIA should include common platform apps that are shared across industries:
...
TECHMEDIA must support offline-to-online workflows for desktop, web where possible, and mobile.
...
TECHMEDIA has two AI assistants with different purposes.
...
ZERO is a business companion inside TECHMEDIA. It helps users understand business data, find records, summarize activity,
...
TECHMEDIA should be enterprise-ready without becoming heavy for small customers.
...
Vibe coding is allowed and encouraged when it stays inside the TECHMEDIA guardrails.
...
- `assist/SKILL.md`: Portable TECHMEDIA module-owner skill for agents on every computer.
...
TECHMEDIA should stay simple at the center and flexible at the edges.
