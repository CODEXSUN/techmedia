...
TECHMEDIA APIs must be tenant-aware, permission-aware, stable, and clear for web, desktop, mobile, workers, integrations, and AI tools.
...
All APIs should return the standard TECHMEDIA envelope.
