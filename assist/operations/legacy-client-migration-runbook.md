...
Use this runbook when moving an older client database into a TECHMEDIA tenant.
...
Every import must map source fields explicitly to target TECHMEDIA modules, tables, and columns. Unknown tables do not import directly into production tables.
...
3. Transform rows into the TECHMEDIA staging shape.
...
- Never hard-delete TECHMEDIA records from old-system deletes without explicit review.
